...
HELP = (
    ...
    "示例：@我 粘贴 https://YOUR_TENANT.feishu.cn/wiki/AbCd1234 到 示例客户公司 示例词包\n"
    ...
    "示例：@我 生文 示例民谣 示例民谣推荐 10 粘贴到 https://YOUR_TENANT.feishu.cn/wiki/AbCd 填到 https://YOUR_TENANT.feishu.cn/wiki/PI5\n"
    "（粘贴到/填到 可省略：只生文就写 @我 生文 示例民谣 示例民谣推荐 10）\n"
...
def parse_command(text):
    ...
    if "把" in text and "粘贴到" in text:
        ...
        # 去掉「（id：YOUR_WRONG_ID_1）」「(编号123)」之类的标注
